...
public class ErrorHandler extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (servletName == null) {
			servletName = "Unknown---servletName";
			System.out.println("Unknown---servletName");
		}
		String requestUri = (String) request.getAttribute("javax.servlet.error.request_uri");
		if (requestUri == null) {
			requestUri = "Unknown---requestUri";
			System.out.println("Unknown---requestUri");

		}
		System.out.println(requestUri + "     " + servletName);
		// 设置响应内容类型
		...
		out.println("</body>");
		out.println("</html>");
		System.out.println(statusCode + "     " + throwable);
